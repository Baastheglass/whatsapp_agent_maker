...
export default function Home() {
  ...
  return (
    <div className="font-sans bg-gray-50 dark:bg-gray-900 flex flex-col">
      <main className="flex-1 flex flex-col items-center justify-start responsive-container py-12 sm:py-16 lg:py-24 min-h-screen">
        {/* Custom Logo/Icon with animations */}
        <div className="flex items-center justify-center mb-12 lg:mb-16 animate-fadeInUp">
          <div className="relative group">
            <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-300 group-hover:shadow-2xl group-hover:scale-110">
              <svg className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-white transition-transform duration-300 group-hover:rotate-12" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute -bottom-2 -right-2 w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 bg-blue-500 rounded-full flex items-center justify-center transition-all duration-300 group-hover:bg-blue-600 group-hover:scale-110 animate-pulse">
              <svg className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-white transition-transform duration-300 group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center max-w-5xl mx-auto px-4 animate-fadeInUp animation-delay-200 mb-12 lg:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-8 lg:mb-12 tracking-tight animate-slideInFromBottom leading-tight">
            WhatsApp Agent Maker
          </h1>
          {session ? (
            <div className="mb-6 lg:mb-8">
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-green-600 dark:text-green-400 font-semibold animate-fadeInUp animation-delay-300">
                Welcome back, {session.user?.firstName || session.user?.name?.split(' ')[0] || session.user?.email}! 👋
              </p>
            </div>
          ) : null}
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-300 mb-6 lg:mb-8 leading-relaxed animate-fadeInUp animation-delay-400 mx-auto">
            Create, deploy, and manage intelligent WhatsApp automation agents with ease.
          </p>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-500 dark:text-gray-400 mb-12 lg:mb-16 animate-fadeInUp animation-delay-600 mx-auto max-w-3xl leading-relaxed">
            Build powerful chatbots, automate customer service, and streamline your WhatsApp business communications.
          </p>
        </div>

        <div className="flex gap-4 sm:gap-6 lg:gap-8 items-center flex-col sm:flex-row mb-16 lg:mb-24 animate-fadeInUp animation-delay-800">
          {session ? (
            // User is logged in - show dashboard and logout
            <>
              <Link
                href="/dashboard"
                className="w-full sm:w-auto rounded-xl bg-gradient-to-r from-green-500 to-green-600 text-white px-8 sm:px-10 lg:px-12 py-4 sm:py-5 lg:py-6 font-semibold text-base sm:text-lg lg:text-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3 hover:from-green-600 hover:to-green-700 group"
              >
                <svg className="w-5 h-5 lg:w-6 lg:h-6 transition-transform duration-300 group-hover:rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <>
              ...
              <Link
                href="/login"
                className="w-full sm:w-auto rounded-xl border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-8 sm:px-10 lg:px-12 py-4 sm:py-5 lg:py-6 font-semibold text-base sm:text-lg lg:text-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-300 flex items-center justify-center gap-3 hover:border-gray-400 dark:hover:border-gray-500 hover:shadow-lg transform hover:scale-105 group"
              >
                <svg className="w-5 h-5 lg:w-6 lg:h-6 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
