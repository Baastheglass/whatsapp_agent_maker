...
export default function Home() {
  ...
  return (
    <div className="font-sans bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <footer className="mt-auto py-6 lg:py-8 pb-8 lg:pb-12 flex flex-col items-center justify-center text-xs lg:text-sm text-gray-500 dark:text-gray-400 space-y-4 lg:space-y-5 animate-fadeInUp animation-delay-1600 responsive-container">
        ...
        <p className="text-xs animate-pulse text-center mb-4 lg:mb-6">Built with ❤️ for WhatsApp automation</p>
      </footer>
    </div>
  );
}
