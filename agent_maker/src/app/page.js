    ...
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 bg-gray-50 dark:bg-gray-900">
      <main className="flex flex-col gap-[32px] row-start-2 items-center">
        ...
        <div className="flex gap-6 items-center flex-col sm:flex-row mb-12">
          <Link
            href="/signup"
            className="rounded-xl bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center gap-2"
          >
          ...
          <Link
            href="/login"
            className="rounded-xl border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-8 py-4 font-semibold text-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200 flex items-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center p-6 rounded-xl bg-white dark:bg-gray-800 shadow-lg">
            ...
            <p className="text-gray-600 dark:text-gray-400">Create intelligent agents that understand context and respond naturally to customer inquiries.</p>
          </div>
          ...
          <div className="text-center p-6 rounded-xl bg-white dark:bg-gray-800 shadow-lg">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Easy Setup</h3>
            <p className="text-gray-600 dark:text-gray-400">Get your WhatsApp agent up and running in minutes with our intuitive drag-and-drop interface.</p>
          </div>
          ...
          <div className="text-center p-6 rounded-xl bg-white dark:bg-gray-800 shadow-lg">
            ...
            <p className="text-gray-600 dark:text-gray-400">Track performance, monitor conversations, and optimize your agents with detailed analytics.</p>
          </div>
        </div>
      </main>
      <footer className="row-start-3 flex flex-col items-center justify-center text-sm text-gray-500 dark:text-gray-400 space-y-2">
        ...
        <p className="text-xs">Built with ❤️ for WhatsApp automation</p>
      </footer>
    </div>
  );
}
