  ...
  return (
    <div className="font-sans min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      <main className="flex-1 flex flex-col items-center justify-center responsive-container py-8 sm:py-12 lg:py-20">
        ...
        {/* Features Grid */}
        <div className="card-grid max-w-6xl mx-auto px-4">
          <div className="responsive-card bg-white dark:bg-gray-800 text-center hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-fadeInUp animation-delay-1000 group">
          ...
          <div className="responsive-card bg-white dark:bg-gray-800 text-center hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-fadeInUp animation-delay-1200 group">
          ...
          <div className="responsive-card bg-white dark:bg-gray-800 text-center hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-fadeInUp animation-delay-1400 group">
