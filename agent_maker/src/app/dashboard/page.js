          ...
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <Link href="/" className="flex items-center">
                ...
                <span className="ml-3 text-xl font-bold text-gray-900 dark:text-white">WhatsApp Agent Maker</span>
              </Link>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="mt-8 space-y-4">
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Your Session Info:</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow text-center">
                    <h5 className="font-semibold text-gray-900 dark:text-white">WhatsApp Agents</h5>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow text-center">
                    <h5 className="font-semibold text-gray-900 dark:text-white">Messages</h5>
                    <p className="text-2xl font-bold text-blue-600 mt-2">0</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Messages sent</p>
                  </div>
                  
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow text-center">
                    <h5 className="font-semibold text-gray-900 dark:text-white">Conversations</h5>
